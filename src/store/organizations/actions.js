import { setOrganizationDashboard, setOrganizations, deleteOrganization, fetchOneOrganization, setOrganizationService } from './slice'
...
export const fetchOrganizationDetails = createAsyncThunk (
    "fetchorganizationdetails/fetchone",
    async (id, thunkApi) => {
        axiosInstance()
...
const postServices = createAsyncThunk (
    "postOrganizationServices",
    async (_, thunkApi) => {
        axiosInstance()
        .post()
        .then(function (response)
        {
            console.log(response)
            thunkApi.dispatch(
                setOrganizationService(response)
